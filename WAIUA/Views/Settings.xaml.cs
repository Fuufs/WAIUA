...
public partial class Settings : UserControl
{
    ...
    private async Task CheckAuthAsync()
    {
        ...
        bool isLoggedIn = await Checks.CheckLoginAsync().ConfigureAwait(false);
        ...
        {
            string username = await GetNameServiceGetUsernameAsync(Constants.Ppuuid).ConfigureAwait(false);
    ...
    private async void Button_Click3Async(object sender, RoutedEventArgs e)
    {
        ...
        {
            Dispatcher.Invoke(() => { AuthStatusBox.Text = Properties.Resources.NoValGame; });
        }
